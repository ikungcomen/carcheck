                ...
                <table class="table table-hover">
                    ...
                    <?php 
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['em_address']." ".$row['em_subdistrict']." ".$row['em_district']."<br>".$row['em_province']; ?></td>
                        <td><?php echo $row['em_postcode']; ?></td>
                        <td class="text-center"><a class=" btn btn-danger " id="<?php echo $row['em_id']; ?>" href="<?php echo base_url(); ?>index.php/EmployeeController/delete_employee/<?php echo $row['em_id']; ?>" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>&nbsp;<a id="dd"  class="btn btn-info"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
                    <?php }?>
                      </tr>
